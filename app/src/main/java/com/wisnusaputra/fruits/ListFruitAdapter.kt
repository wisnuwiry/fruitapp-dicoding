...
class ListFruitAdapter(private val listFruit: ArrayList<Fruit>) :
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        i: Int
    ): ListFruitAdapter.ListViewHolder {
        val view: View =
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val (name, detail, photo) = listFruit[position]
        ...
        holder.preview.setOnClickListener{onItemClickCallback.onItemClicked(listFruit[holder.adapterPosition])}
    }

    inner class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var tvName: TextView = itemView.findViewById(R.id.tv_item_name)
        var tvDetail: TextView = itemView.findViewById(R.id.tv_item_detail)
        var imgPhoto: ImageView = itemView.findViewById(R.id.img_item_fruit)
